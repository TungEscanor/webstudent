    ...
    <div class="grid-form">
        ...
        <div class="content-top-1">
            ...
            <div class="form-group" style="margin-right: 50px">
                ...
                {{Form::text('min_age',isset($data['min_age']) ? $data['min_age'] : '0', ['id'=> 'min1','class' => 'form-control','style' => 'width: 60px'])}}
                {{Form::label('max1','To: ')}}
                {{Form::text('max_age',isset($data['max_age']) ? $data['max_age'] : '50', ['id'=> 'max1','class' => 'form-control','style' => 'width: 60px'])}}
            </div>
            ...
            <div class="form-group">
                ...
                {{Form::text('min_mark',isset($data['min_mark']) ? $data['min_mark'] : '0', ['id'=> 'mark1','class' => 'form-control','style' => 'width: 60px'])}}
                {{Form::label('mark2','To: ')}}
                {{Form::text('max_mark',isset($data['max_mark']) ? $data['max_mark'] : '10', ['id'=> 'mark2','class' => 'form-control','style' => 'width: 60px'])}}
            </div>
            <br><br>
            <div class="form-group">
